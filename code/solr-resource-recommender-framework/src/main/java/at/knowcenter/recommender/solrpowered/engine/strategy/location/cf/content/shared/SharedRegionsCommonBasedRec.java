...
public class SharedRegionsCommonBasedRec implements RecommendStrategy{
		...
		try {
			...
			Thread t = new Thread() {
				@Override public void run() {
					UserSimilarityTracker.getInstance().writeToFile("loc_content_shared_cn", user, commonNeighborMap);
				}
			};
			t.start();
