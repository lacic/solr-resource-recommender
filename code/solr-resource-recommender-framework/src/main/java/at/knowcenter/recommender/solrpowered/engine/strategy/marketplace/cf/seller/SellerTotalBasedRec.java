 ...
 *
 */
public class SellerTotalBasedRec implements RecommendStrategy {
		...
		try {
			...
			Thread t = new Thread() {
				@Override public void run() {
					UserSimilarityTracker.getInstance().writeToFile("soc_market_seller_tot", user, commonNeighborMap);
				}
			};
			t.start();
