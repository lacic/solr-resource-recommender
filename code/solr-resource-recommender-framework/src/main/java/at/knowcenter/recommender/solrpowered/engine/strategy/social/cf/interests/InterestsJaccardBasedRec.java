package at.knowcenter.recommender.solrpowered.engine.strategy.social.cf.interests;
...
public class InterestsJaccardBasedRec implements RecommendStrategy {
		...
		try {
			...
			Thread t = new Thread() {
				@Override public void run() {
					UserSimilarityTracker.getInstance().writeToFile("soc_content_interest_jac", user, customerScoringMap);
				}
			};
			t.start();
