...
public class CommonRegionsTotalBasedRec implements RecommendStrategy{
		...
		try {
			...
			Thread t = new Thread() {
				@Override public void run() {
					UserSimilarityTracker.getInstance().writeToFile("loc_content_commonreg_tot", user, commonNeighborMap);
				}
			};
			t.start();
