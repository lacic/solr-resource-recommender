...
public class CommonStrategyJob extends AbstractStrategyJob implements Callable<List<MetricsExporter>>{

	protected List<String> users;
	protected int orderNumber = 0;
	protected StrategyType evaluatingStrategy;

	public CommonStrategyJob(List<String> users, String jobDescription, StrategyType strategy, int evalOrder) {
		this.users = users;
