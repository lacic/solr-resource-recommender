 ...
 *
 */
public class CFSocialInteractionsRecommender implements RecommendStrategy {
	...
	public RecommendResponse recommend(RecommendQuery query, Integer maxReuslts){
		...
		try {
			...
			if (currentUserInteractions != null && currentUserInteractions.getUsersThatCommentedOnMyPost() != null) {
				for(String userCommentedOnCurrentUser : currentUserInteractions.getUsersThatCommentedOnMyPost()) {
			...
			if (currentUserInteractions != null && currentUserInteractions.getUsersThatLikedMe() != null) {
				for(String userLikedCurrentUser : currentUserInteractions.getUsersThatLikedMe()) {
