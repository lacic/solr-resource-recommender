package at.knowcenter.recommender.solrpowered.engine.strategy.social.combined;
 ...
 * link strength based on the Preferential Attachment Score between users (is replaced)
 * 
 * 
 * @author elacic
 *
 */
public class CFPurchWithSocCommonNeighborhoodReplacedRecommender implements RecommendStrategy {
