...
public class CommonHybridWeightedSumStrategyJob extends AbstractHybridWeightedSumStrategyJob implements Callable<List<MetricsExporter>>{
...
//		
//		definedStrategyWeights.put(StrategyType.CF_Categories_CN, 						0.0079);
//		definedStrategyWeights.put(StrategyType.CF_Categories_Jacc, 					0.0079);
//		definedStrategyWeights.put(StrategyType.CF_Categories_Total, 					0.0014);
//		
