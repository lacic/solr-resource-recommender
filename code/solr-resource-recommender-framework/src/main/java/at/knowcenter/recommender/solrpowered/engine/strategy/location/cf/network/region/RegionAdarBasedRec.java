...
public class RegionAdarBasedRec implements RecommendStrategy{
	...
	public RecommendResponse recommend(RecommendQuery query, Integer maxReuslts) {
		...
		try {
			...
			for (PositionNetwork neighbourPosition : neighbourPositions) {
				degreeMap.put(neighbourPosition.getUserId(), neighbourPosition.getRegionNeighborsCount());
			}
	...
	public StrategyType getStrategyType() {
		return StrategyType.CF_Region_Network_All_Adar;
	}
