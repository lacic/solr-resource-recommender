...
public class LocationPrefAttBasedRec implements RecommendStrategy{
	...
	public RecommendResponse recommend(RecommendQuery query, Integer maxReuslts) {
		...
		try {
			...
			solrParams.set("sort", "global_neighborhood_count desc");
			...
			for (PositionNetwork otherPosition : otherPositions) {
				commonNeighborMap.put(otherPosition.getUserId(), 
						locationNeighbors.size() * (double)otherPosition.getLocationNeighborsCount());
			}
	...
	public StrategyType getStrategyType() {
		return StrategyType.CF_Location_Network_All_PrefAtt;
	}
