...
public class GroupJaccardBasedRec implements RecommendStrategy {
		...
		try {
			...
			Thread t = new Thread() {
				@Override public void run() {
					UserSimilarityTracker.getInstance().writeToFile("soc_content_group_jacc", user, customerScoringMap);
				}
			};
			t.start();
