package at.knowcenter.recommender.solrpowered.engine.strategy.marketplace.cb.combinations;
 ...
 *
 */
public class NameDescriptionWeightedBasedRec extends NameDescriptionBasedRec {
	...
	protected ModifiableSolrParams initMLTParams(String filterQuery, int maxResultCount, String query) {
		...
		params.set("mlt.mintf", "2");
		params.set("mlt.qf","name^17.0 description^3.0");
		return params;
	}
