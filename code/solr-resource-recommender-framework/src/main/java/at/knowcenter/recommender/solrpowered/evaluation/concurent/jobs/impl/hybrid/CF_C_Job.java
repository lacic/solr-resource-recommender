...
public class CF_C_Job extends RecommenderEvaluator implements Callable<List<MetricsExporter>>{

	private List<String> users;

	public CF_C_Job(List<String> users, String jobDescription) {
	...
	public List<MetricsExporter> evaluate() {
		...
		for (int n = 1; n <= resultSize; n++) {
			...
			mCalc.setAlgorithmName("3_CF-C_stress");
