 ...
 *
 */
public class CategoryTotalBasedRec implements RecommendStrategy {
		...
		try {
			...
			Thread t = new Thread() {
				@Override public void run() {
					UserSimilarityTracker.getInstance().writeToFile("soc_market_cat_tot", user, commonNeighborMap);
				}
			};
			t.start();
