...
public class InterestsTotalBasedRec implements RecommendStrategy {
		...
		try {
			...
			Thread t = new Thread() {
				@Override public void run() {
					UserSimilarityTracker.getInstance().writeToFile("soc_content_interest_tot", user, customerScoringMap);
				}
			};
			t.start();
